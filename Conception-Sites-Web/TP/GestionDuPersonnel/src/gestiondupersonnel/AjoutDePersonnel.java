 ...
 * @author diawara
 */
public class AjoutDePersonnel extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public AjoutDePersonnel() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AjoutDePersonnel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AjoutDePersonnel().setVisible(true);
            }
        });
    }
